...
export class HeaderComponent implements OnInit {
  ...
  public openButton =
    "<i class='fa-solid fa-ellipsis-vertical iconMenu text-white fs-3'></i>";
  public closeButton =
    "<i class='fa-solid fa-xmark iconMenu text-white fs-3'></i>";
  ...
  ngOnInit(): void {
    ...
    responseData.subscribe((data) => {
      ...
      this.selectedAdminId =
        storedId !== null ? storedId : this.administrationList[0].id;
